...
public abstract class RandomTeleportEngine {
     ...
     * locations on this server, and override {@link #getRandomPosition(OnlineUser, String...)} to return a random position
     ...
     *
     * @param origin The origin {@link Location} to generate a random position around, such as the server spawn, or
     *               ({@code x: 0, z: 0})
     ...
     *
     * @param onlineUser The {@link OnlineUser} requesting the random position
     * @param args       Arguments specified by the random location request. These may be used to alter which locations are
     *                   generated by the randomizer.
     * @return a generated {@link Location} if one was found; an {@link Optional#empty()} otherwise
     * @since 3.0
     ...
     *
     * @param world the {@link World} to search for a random {@link Location}. Note that ({@code x: 0, z: 0}) will be
     *              passed as the origin position in the world
     * @param args  Arguments specified by the random location request. These may be used to alter which locations are
     *              generated by the randomizer.
     * @return a generated {@link Location} if one was found; an {@link Optional#empty()} otherwise
     * @since 3.0
