...
# Create
the positions table if it does not exist
...
#
Create
the players table if it does not exist
...
#
Create
the current cross-server teleports table if it does not exist
...
#
Create
the saved positions table if it does not exist
...
#
Create
the homes table if it does not exist
...
(
    `saved_position_id`
) REFERENCES `%saved_positions_table%`
(
    `id`
)
  ON DELETE CASCADE
...
#
Create
the warps table if it does not exist
