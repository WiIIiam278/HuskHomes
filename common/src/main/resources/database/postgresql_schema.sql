...
(
    ...
    PRIMARY KEY (uuid),
    FOREIGN KEY (last_position) REFERENCES "%positions_table%" (id) ON DELETE SET NULL,
    FOREIGN KEY (offline_position) REFERENCES "%positions_table%" (id) ON DELETE SET NULL,
    FOREIGN KEY (respawn_position) REFERENCES "%positions_table%" (id) ON DELETE SET NULL
);
...
(
    ...
    FOREIGN KEY (player_uuid) REFERENCES "%players_table%" (uuid) ON DELETE CASCADE ON UPDATE CASCADE,
    FOREIGN KEY (destination_id) REFERENCES "%positions_table%" (id) ON DELETE CASCADE
);
...
(
    ...
    PRIMARY KEY (id),
    FOREIGN KEY (position_id) REFERENCES "%positions_table%" (id) ON DELETE CASCADE
);
...
(
    ...
    FOREIGN KEY (saved_position_id) REFERENCES "%saved_positions_table%" (id) ON DELETE CASCADE
);
