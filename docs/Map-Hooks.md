...
* [Pl3xMap](https://github.com/BillyGalbreath/Pl3xMap) (Paper 1.20.1+ servers only)
...
## Pl3xMap
To enable Pl3xMap support, ensure that the `map_hook` is enabled in config.yml and that the latest version of Pl3xMap is installed and that you are running Paper on Minecraft 1.20.1+. Once installed, restart your server and public homes and warps to be populated on your map.
