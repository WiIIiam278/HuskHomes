...
public class HuskHomesCommand extends CommandBase implements TabCompleter {
    ...
    private static final StringBuilder PLUGIN_INFORMATION = new StringBuilder()
            ...
            .append("[• Translators:](white) [SnivyJ](gray show_text=&7Simplified Chinese, zh-cn), [TonyPak](gray show_text=&7Traditional Chinese, zh-tw), [Villag3r_](gray show_text=&7Italian, it-it), [ReferTV](gray show_text=&7Polish, pl), [anchelthe](gray show_text=&7Spanish, es-es) \n")
